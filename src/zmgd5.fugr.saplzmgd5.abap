...
*******************************************************************
  INCLUDE LZMGD5TOP.                         " Global Declarations
  INCLUDE LZMGD5UXX.                         " Function Modules

*******************************************************************
*   User-defined Include-files (if necessary).                    *
*******************************************************************
* INCLUDE LZMGD5F...                         " Subroutines
* INCLUDE LZMGD5O...                         " PBO-Modules
* INCLUDE LZMGD5I...                         " PAI-Modules
* INCLUDE LZMGD5E...                         " Events
* INCLUDE LZMGD5P...                         " Local class implement.
* INCLUDE LZMGD5T99.                         " ABAP Unit tests
